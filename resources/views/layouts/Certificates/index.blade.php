    ...
    <section id="blog-subheader"
        ...
        <div class="overlay-bg t80">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1>@lang('navbar.certificates')</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                @if($certificates->count())
                    ...
                    @foreach($certificates as $certificate)
                          <div  class="card" style="margin-right: auto;margin-left: auto">
                              <a href="{{action('HomeController@certificate',$certificate)}}"><div class="image" style="width: 100%; background-color: white; margin: auto; margin-top: 10%;margin-bottom: 10% ">
                                        <img style="max-width: 100%; max-height: 100%" src="{{url('/storage/'.$certificate->image_path)}}">
                                    </div></a>
